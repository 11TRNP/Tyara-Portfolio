    ...
    <motion.div id='about' className='w-full px-[12%] py-10 scroll-mt-20'
      ...
      <motion.div initial={{opacity:0}} whileInView={{opacity: 1}} transition={{duration: 0.8}}
        ...
        <motion.div initial={{opacity:0, scale: 0.9}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 0.6}}
          ...
          <Image src={assets.tyr_image} alt='user' className='w-full rounded-3xl gap-8 my-10' />
          <Image src={assets.tyrr} alt='user' className='w-full rounded-3xl gap-8 my-10' />
          <Image src={assets.tyrrr} alt='user' className='w-full rounded-3xl gap-8 my-10' />
        </motion.div>
