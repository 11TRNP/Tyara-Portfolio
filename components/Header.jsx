  ...
  return (
    <div className='w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4'>
      ...
      className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo'>
          Hi! I'm Tyara Regina <Image src={assets.hand_icon} alt='' className='w-6'/>
      </motion.h3>
      ...
      className='text-3xl sm:text-5xl lg:text-[55px] font-Ovo'>
        Fullstack & Data Specialist <br/> based in Bekasi, Indonesia.
      </motion.h1>
        ...
        className='max-w-2xl mx-auto font-Ovo text-center'>
          I'm a Fullstack & Data Specialist from Bekasi with experience at PT Bank Negara Indonesia (Persero) Tbk, contributing to diverse industry projects.
        </motion.p>
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
          ...
          href="/tyara-resume.pdf" download 
