...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "9c9c195a-1160-4f50-a483-f232037e70cd");
    ...
    initial={{opacity:0}} whileInView={{opacity: 1}} transition={{duration: 1}}>
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
          ...
          className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-whit dark:bg-darkHover/30 dark:border-white/90e' name='email'/>
        </div>
